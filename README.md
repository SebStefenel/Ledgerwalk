...
[![CI](https://github.com/SebStefenel/Ledgerwalk/actions/workflows/ci.yml/badge.svg)](https://github.com/SebStefenel/Ledgerwalk/actions/workflows/ci.yml)

Finds your recurring subscriptions in bank statements and billing emails, drives a
hand-written browser agent over each provider's billing page to read the plan and
renewal date, then suggests open-source alternatives — and says plainly when there
isn't one.
...
- **Total annual spend:** 617.39
- **Plausible annual savings:** 335.64 (2 of 5 subscription(s) have a real alternative)
- 2 subscription(s) not yet checked — run `npm run alternatives`

### Needs attention

- ⏳ **BEAR** — free trial ends 2026-10-01, then GBP 29.99 annual (29.99/year).
- ↑ **NETFLIX** — price rose from 4.99 to 9.99 (+100%) on 2026-01-07.
- ⚠ **NOTION LABS** — billing page not read: the saved session had expired. Figures below come from statements and receipts only.

### Upcoming renewals

| Renews | Service | Amount |
| --- | --- | ---: |
| 2026-09-28 | SPOTIFY | GBP 10.99 |
| 2026-10-01 | BEAR (trial ends) | GBP 29.99 |
| 2026-10-12 | NETFLIX | GBP 9.99 |

### Subscriptions

| Service | Annual cost | Alternative | License | Self-host | Migration | Savings | Features lost |
| --- | ---: | --- | --- | :---: | :---: | ---: | --- |
| [ADOBE](traces/adobe-2026-09-07T09-43-11) — Photography | 239.64 | [GIMP + Inkscape + Darktable](https://github.com/GNOME/gimp) · 4,212★ · **unmaintained since 2023-02-11** | GPL-3.0 | no | high | 239.64 | no Creative Cloud sync; poorer CMYK and print output |
| [SPOTIFY](traces/spotify-2026-09-07T09-41-02) — Premium Duo | 131.88 | _not checked_ | — | — | — | — | — |
| NETFLIX — Standard with ads | 119.88 ↑ | _none_ | — | — | — | — | — |
| [NOTION LABS](traces/notion-labs-2026-09-07T09-45-30) | 96.00 | [AppFlowy](https://github.com/AppFlowy-IO/AppFlowy) · 61,234★ | AGPL-3.0 | no | medium | 96.00 | real-time multiplayer editing is less mature; weaker mobile apps |
| BEAR — Pro Yearly **(trial)** | 29.99 | _not checked_ | — | — | — | — | — |

### Notes

- **ADOBE** — GIMP + Inkscape + Darktable: Together these cover the raster, vector and raw workflows, though not as one integrated suite. _(confidence: medium)_
- **NETFLIX** — no alternative _(content licensing)_: Netflix is a licensed film and television catalogue. No software you run yourself can license the catalogue. _(confidence: high)_
- **NOTION LABS** — AppFlowy: Same documents-and-databases model, and it imports Notion exports, so the day-to-day workflow survives. _(confidence: high)_
...
> Generated by running the pipeline over the synthetic statements and receipts in
> `test/fixtures/`, not a real account. Headings are demoted one level to nest
> under this README; the content is otherwise exactly what `npm run report` prints.

Reading it: **Bear** is a free trial found in an email that will start charging on
1 October. **Netflix** doubled in price in January — the annual cost shown is what
it costs now, not what it used to. **Notion** could not be audited because the saved
session expired, so its figures come from statements alone. **Netflix** has no
open-source alternative and the tool says so rather than inventing one.
